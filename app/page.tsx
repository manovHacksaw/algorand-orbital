    ...
    <section className="mx-auto max-w-6xl px-4 pt-20 pb-16 md:pt-28">
      <div className="flex flex-col items-center text-center">
        ...
        <p className="mt-6 max-w-xl text-center text-muted-foreground">
          {"A multi-stablecoin AMM powered by spherical geometry — one pool, unlimited stables, concentrated liquidity in every dimension."}
        </p>

        <div className="mt-10 text-sm text-muted-foreground">Built for Algorand.</div>
      </div>
    </section>
  </main>
  );
